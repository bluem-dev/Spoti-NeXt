              ...
              <td className="p-4 align-middle text-center">
                <div className="flex items-center justify-center gap-1">
                  {track.spotify_id && (<Tooltip>
                    ...
                    <TooltipContent>
                      {downloadingTrack === track.spotify_id ? (<p>Downloading...</p>) : skippedTracks.has(track.spotify_id) ? (<p>{t("alreadyExists")}</p>) : downloadedTracks.has(track.spotify_id) ? (<p>Downloaded</p>) : failedTracks.has(track.spotify_id) ? (<p>Failed</p>) : (<p>Download Track</p>)}
                    </TooltipContent>
                  </Tooltip>)}
                  {track.spotify_id && (<Tooltip>
                    <TooltipTrigger asChild>
                    ...
                    <TooltipContent>
                      <p>{playingTrack === track.spotify_id ? t("stopPreview") : t("playPreview")}</p>
                    </TooltipContent>
                  </Tooltip>)}
