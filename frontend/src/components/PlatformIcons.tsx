...
export function DeezerIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    const cleanedClassName = sanitizeClassName(className);
    return <svg viewBox="0 0 24 24" className={`${cleanedClassName || "w-4 h-4"} inline-block shrink-0`} fill="currentColor" aria-label="Deezer">
        <path d="M18.81 11.283H24v1.659h-5.19zm0 2.92H24v1.66h-5.19zm0-5.841H24V10.02h-5.19zm0 8.76H24v1.66h-5.19zm0 2.921H24v1.659h-5.19zM12.495 14.2h5.19v1.659h-5.19zm0 2.921h5.19v1.66h-5.19zm0-5.838h5.19v1.659h-5.19zm0 8.759h5.19v1.659h-5.19zM6.18 17.122h5.19v1.659H6.18zm0 2.92h5.19v1.659H6.18zm0-5.841h5.19v1.659H6.18zM0 20.043h5.19v1.659H0z"/>
    </svg>;
}
