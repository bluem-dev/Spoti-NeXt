...
export function HistoryPage({ onHistorySelect }: HistoryPageProps) {
    ...
    const getTrackLink = (spotifyId: string) => {
        ...
        return { url: `https://open.spotify.com/track/${spotifyId}`, label: t("openInSpotify") };
    };
                ...
                <div className="flex flex-col gap-4">
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                             <h2 className="text-xl font-bold tracking-tight">{t("downloads")}</h2>
    ...
    const renderFetchHistory = () => {
        ...
        return (<div className="space-y-6">
                <div className="flex flex-col gap-4">
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                             <h2 className="text-xl font-bold tracking-tight">{t("fetches")}</h2>
    ...
    return (<div className="space-y-6">
            ...
            <Dialog open={showClearDownloadConfirm} onOpenChange={setShowClearDownloadConfirm}>
                <DialogContent className="max-w-md [&>button]:hidden">
                    <DialogHeader>
                        <DialogTitle>{t("clearDownloadHistoryTitle")}</DialogTitle>
                        <DialogDescription>{t("clearDownloadHistoryConfirmDesc")}</DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button variant="outline" onClick={() => setShowClearDownloadConfirm(false)} className="cursor-pointer">{t("cancel")}</Button>
