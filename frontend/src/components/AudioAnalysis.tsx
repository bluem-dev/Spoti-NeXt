...
export function AudioAnalysis({ result, analyzing, onAnalyze, showAnalyzeButton = true, filePath }: AudioAnalysisProps) {
                ...
                <CardContent className="px-6">
                    <div className="flex flex-col items-center justify-center py-8 gap-4">
                        ...
                        <div className="text-center space-y-2">
                            <p className="font-medium">{t("audioQualityAnalysis")}</p>
    ...
    return (<Card className="gap-2">
            ...
            <CardContent>
                <div className={`grid grid-cols-1 gap-6 md:grid-cols-2 ${hasCodecMeta ? "lg:grid-cols-4" : "lg:grid-cols-3"}`}>
                    <div className="space-y-2">
                        <p className="text-xs font-semibold tracking-wider text-muted-foreground uppercase">{t("analysisFormatLabel")}</p>
                        <ul className="text-sm space-y-1">
                            ...
                            <li className="flex justify-between">
                                ...
                                <span className="font-medium font-mono">{result.channels === 2 ? t("analysisStereo") : result.channels === 1 ? t("analysisMono") : `${result.channels}`}</span>
                            </li>
                            <li className="flex justify-between">
                    ...
                    <div className="space-y-2">
                        <p className="text-xs font-semibold tracking-wider text-muted-foreground uppercase">{t("analysisSignalAnalytics")}</p>
                        <ul className="text-sm space-y-1">
                            <li className="flex justify-between">
            ...
            return (<div className="space-y-2">
                                <p className="text-xs font-semibold tracking-wider text-muted-foreground uppercase">{t("analysisSpectrumMeta")}</p>
                                <ul className="text-sm space-y-1">
                                    <li className="flex justify-between">
