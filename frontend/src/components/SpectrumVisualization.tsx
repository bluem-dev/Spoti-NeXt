    ...
    return (<div className="space-y-4">
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 p-1">
                <div className="flex items-center gap-2">
                    <Label className="whitespace-nowrap text-sm font-medium">{t("spectrumColorScheme")}</Label>
                ...
                <div className="flex items-center gap-2">
                    <Label className="whitespace-nowrap text-sm font-medium">{t("spectrumFreqScale")}</Label>
                    <Select value={freqScale} onValueChange={(v) => setFreqScale(v as FreqScale)} disabled={isAnalyzingSpectrum}>
                        ...
                        <SelectContent>
                            <SelectItem value="linear">{t("spectrumLinear")}</SelectItem>
                ...
                <div className="flex items-center gap-2">
                    <Label className="whitespace-nowrap text-sm font-medium">{t("spectrumFftSize")}</Label>
                ...
                <div className="flex items-center gap-2">
                    <Label className="whitespace-nowrap text-sm font-medium">{t("spectrumWindow")}</Label>
                    <Select value={windowFunction} onValueChange={(v) => handleReAnalyze(fftSize, v)} disabled={isAnalyzingSpectrum}>
                        ...
                        <SelectContent>
                            <SelectItem value="hann">{t("spectrumHann")}</SelectItem>
                            <SelectItem value="hamming">{t("spectrumHamming")}</SelectItem>
                            <SelectItem value="blackman">{t("spectrumBlackman")}</SelectItem>
                            <SelectItem value="rectangular">{t("spectrumRectangular")}</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
            </div>
